...
import { updatePairDayData, updateTokenDayData, updateSwapdexDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = SwapdexFactory.load(FACTORY_ADDRESS)
...
export function handleSwap(event: Swap): void {
  ...
  let uniswapDayData = updateSwapdexDayData(event)
